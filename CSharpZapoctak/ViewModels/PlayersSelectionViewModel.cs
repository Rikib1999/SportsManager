...
{
    public class PlayersSelectionViewModel : NotifyPropertyChanged
    {
        #region Commands
        ...
        public PlayersSelectionViewModel(NavigationStore navigationStore)
        {
            ...
            #region old code
            /* old query, query each player and stat individually
            ...
            */
            ...
            string playerStatsQuery = "SELECT p.*, s.competition_id, IFNULL(match_count, 0) AS match_count, IFNULL(goal_count, 0) AS goal_count, " +
                                      "IFNULL(assist_count, 0) AS assist_count, IFNULL(penalty_minutes, 0) AS penalty_minutes " +
                                      "FROM player_enlistment " +
